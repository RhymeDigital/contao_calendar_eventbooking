...
require_once('../system/modules/calendar_eventbooking/libs/Format.php');
require_once('../system/modules/calendar_eventbooking/libs/OLEwriter.php');
require_once('../system/modules/calendar_eventbooking/libs/BIFFwriter.php');
