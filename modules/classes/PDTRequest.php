...
/**
 * Handle Paypal PDTRequests
 * 
 * @extends PayPal_standard
 */
class PDTRequest extends \PayPal_standard

{
	...
	function __construct($host, $method = 'POST', $ssl = false, $port = 0) {
		$this->host = $host;
